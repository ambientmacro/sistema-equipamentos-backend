...
public class ExecucaoResumoDTO {
    ...
    public ExecucaoResumoDTO(
        ...
        this.checklistModelo = checklistModeloId == null && checklistModeloNome == null && checklistModeloArquivoNome == null
                ? null
                : new ChecklistModeloResumoDTO(checklistModeloId, checklistModeloNome, checklistModeloArquivoNome);
    }
}
