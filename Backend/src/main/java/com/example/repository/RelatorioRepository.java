...
public interface RelatorioRepository extends JpaRepository<Relatorio, Long> {
    ...
    @EntityGraph(attributePaths = {
            "equipe","equipe.tipoCategoria",
            "estoque","estoque.empresa",
            "estoque.equipeResponsavel","estoque.equipeResponsavel.tipoCategoria",
            "checklistExecucao","checklistExecucao.checklistModelo"
    })
